<template>
  <div
    class="border-l border-[#444746] w-[500px] flex justify-start items-center p-4 text-white flex-col gap-2"
  >
    ...
    <div class="max-h-[calc(100vh-250px)]">
      <img
        ...
        :src="`data:image/jpg;base64, ${activePicture.Content}`"
      />
    </div>
    <div class="flex flex-col gap-4 w-full">
      <div class="grid grid-cols-3 gap-3">
        ...
        >
          <p class="truncate flex justify-center items-center p-1" :title="tag">
            {{ tag }}
          </p>
        </div>
      </div>
      <div class="flex flex-row w-full gap-3">
        ...
        >
          <Icon name="carbon:add" class="text-white" size="24px" />
        </div>
      </div>
    </div>
  </div>
