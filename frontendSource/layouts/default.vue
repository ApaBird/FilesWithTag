<template>
  <div class="flex bg-[#131314] w-full">
    <div class="h-screen p-4 flex flex-col gap-4 w-full">
      <input
...
const activePicture = computed(() => itemStore().item.Content);
</script>
